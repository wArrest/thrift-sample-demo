...
class EchoClient implements \ThriftSampleDemo\EchoIf
{
    ...
    public function send_echo(\ThriftSampleDemo\EchoReq $req)
    {
        $args = new \ThriftSampleDemo\Echo_echo_args();
        $args->req = $req;
    ...
    public function recv_echo()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\ThriftSampleDemo\Echo_echo_result',
            ...
            $result = new \ThriftSampleDemo\Echo_echo_result();
